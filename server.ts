...
// 나쁜 trust proxy 설정 예시:
// app.set("trust proxy", true)
// ("trust proxy", true) 로 설정하면 Express는 **“모든 프록시(0.0.0.0/0 IP CIDR 범위)를 신뢰”**하게 됩니다.
// 즉, 숫자(1, 2, 3...)처럼 hop 개수를 지정하는 대신,
// 들어온 X-Forwarded-For 체인 전체를 신뢰하고, 맨 왼쪽(첫 번째) IP를 원본 클라이언트 IP로 간주합니다.

// 좋은 trust proxy 설정 예시:
// app.set('trust proxy', [
//   'loopback',        // 127.0.0.1, ::1
//   '10.0.0.0/8',      // AWS VPC CIDR (ALB 포함)
//   '172.16.0.0/12',   // 사설망 (Cloudflare Tunnel 등)
//   '192.168.0.0/16'   // 로컬망
// ]);
app.set("trust proxy", true); // ALB 유무와 개수에 따라 정확하게 수정 필요!
